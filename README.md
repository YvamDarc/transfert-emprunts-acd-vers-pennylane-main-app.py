...
- La ligne ACD `N° 0` est utilisée comme capital initial puis retirée de l'échéancier.
...
- L'assurance reste distincte et la commission est regroupée avec la colonne `Autre`.
- L'échéance Pennylane est calculée par défaut comme `Annuité ACD + Assurance + Commission + Autre`.
- Le solde est contrôlé à chaque ligne selon `solde précédent - capital remboursé`.
